...
func GetVirtualNetworkList(azureTestClient *client.AzureTestClient) (result aznetwork.VirtualNetworkListResultPage, err error) {
...
func GetClusterVirtualNetwork(azureTestClient *client.AzureTestClient) (ret aznetwork.VirtualNetwork, err error) {
...
func CreateSubnet(azureTestClient *client.AzureTestClient, vnet aznetwork.VirtualNetwork, subnetName *string, prefix *string) error {
...
func DeleteSubnet(azureTestClient *client.AzureTestClient, vnetName string, subnetName string) error {
